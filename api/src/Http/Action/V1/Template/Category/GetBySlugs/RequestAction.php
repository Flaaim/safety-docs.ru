...
namespace App\Http\Action\V1\Template\Category\GetBySlugs;

use App\Http\JsonResponse;
use App\Http\Validator\Validator;
use App\Template\Query\Category\GetBySlugs\Handler;
use App\Template\Query\Category\GetBySlugs\Query;
