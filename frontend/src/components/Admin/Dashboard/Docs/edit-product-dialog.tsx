    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[600px]">
        <DialogHeader>
          ...
          <DialogDescription>Изменение продукта на странице.</DialogDescription>
        </DialogHeader>
        {loading || !productData ? (
          <div>Загрузка...</div>
        ) : (
          <form key={productData.id} onSubmit={onSubmit} className="grid gap-4 py-4">
            ...
            <div className="grid gap-2">
              ...
              <Input
                ...
                type="text"
                name="cipher"
                defaultValue={productData.cipher}
                required
              />
            </div>
            <div className="grid gap-2">
              ...
              <Input
                ...
                name="amount"
                defaultValue={
                  productData.formattedPrice ? parseFloat(productData.formattedPrice) : 0
                }
                required
              />
            </div>
              ...
              <Input
                ...
                defaultValue={
                  productData.updatedAt
                    ? new Date(productData.updatedAt).toISOString().split("T")[0]
                    : ""
                }
                required
              />
            ...
            <div className="grid gap-2">
              ...
              <Input
                ...
                type="number"
                name="totalDocuments"
                defaultValue={productData.totalDocuments}
              ></Input>
            </div>
            <div className="grid gap-2">
